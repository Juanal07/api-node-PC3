...
router.post("/api/municipality/restaurants_new", municipality.restaurantes_new);
router.get("/api/municipality/infoexamen", municipality.infoExamen);
...
router.get(
    "/api/admin/muniScrapeados",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.muniScrapeados
);
router.get(
    "/api/admin/RegisterMes",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.RegisterMes
);
router.get(
    "/api/admin/activosInactivos",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.activosInactivos
);
router.get(
    "/api/admin/rankingsActivos",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.rankingsActivos
);
router.get(
    "/api/admin/actividadDiaria",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.actividadDiaria
);
router.get(
    "/api/admin/muniBuscados",
    middleware.verifyToken,
    middleware.verifyAdmin,
    admin.muniBuscados
);
